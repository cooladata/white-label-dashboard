...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="../account/index.php"><img src="http://2tzh7r3wph5u3juauw103v2w.wpengine.netdna-cdn.com/wp-content/uploads/2015/05/coola.png" alt="CoolaData"></a>
    #HEADERMESSAGE#
</div>
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
    ...
    foreach ($menu as $r => $v){
        ...
        if ($v['menu'] == 'left' AND $v['menu'] != 'left-sub'){
            $html .= "<li class='navitem-".$v['class_name']." $active'><a href='../".$v['page']."' style=\"color:black\"><i class='".$v['icon']."'></i> ".$v['name']."</a></li>";
        }
