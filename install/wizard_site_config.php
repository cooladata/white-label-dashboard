...
<head>
    ...
    <title>Welcome to Cooladata!</title>
...
<div class="container">
    <div class="header">
        ...
        <h3 class="text-muted">Cooladata</h3>
    </div>
    <!-- Start Form Input -->
        ...
        <div class="panel panel-primary">
            ...
            <div id='newInstall' class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name='site_name' value='Cooladata' data-validate='{"minLength": 1, "maxLength": 150, "label": "Website Name"}'>
                        </div>
                ...
                <div class="row form-group">
			        <label class="col-sm-4 control-label">Partner id Alias</label>
			        <div class="col-sm-8">
				        <div class="input-group">
					        <span class='input-group-addon'><i class='fa fa-envelope'></i></span>
					        <input type="text" class="form-control" placeholder="Partner Id Alias" name='Partner_id_Alias' data-validate='{"minLength": 1, "maxLength": 150, "label": "Partner Id Alias" }'>
				        </div>
						<br><small>Define the property name in your project, that is used to differentiate between partners (e.g. partner_id, affiliate_id, etc.)</small>
			        </div>
		        </div>		  
                <div class="form-group">
                    <label class="col-sm-4 control-label">Enable User Registration</label>
                    <div class="col-sm-8">
                        <input type="checkbox" name="can_register" />
    ...
    <div class="footer">
        <p>&copy; <a href="http://www.userfrosting.com">Cooladata</a> Installer, 2014</p>
    </div>
			...
			if (errorMessages.length > 0) {
                ...
                $.ajax({  
                  ...
                  data: {
                    ...
                    Partner_id_Alias:			form.find('input[name="Partner_id_Alias"]').val(),
